# Generated by Django 3.0.5 on 2020-06-06 15:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Categorie_Conges', models.CharField(choices=[('Congés Déductibles', 'Congés Déductibles'), ('Congés Non Déductibles', 'Congés Non Déductibles'), ('Congés Annuels', 'Congés Annuels')], default=(('Congés Déductibles', 'Congés Déductibles'), ('Congés Non Déductibles', 'Congés Non Déductibles'), ('Congés Annuels', 'Congés Annuels')), max_length=100)),
                ('Motif', models.CharField(default='', max_length=2500)),
            ],
        ),
        migrations.CreateModel(
            name='Notes_Internes',
        ...
        migrations.CreateModel(
            name='Utilisateur',
            fields=[
                ('Matricule', models.CharField(default='20200606161435425271', max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aujourdhui', models.DateField(default=datetime.datetime(2020, 6, 6, 16, 14, 35, 427931), verbose_name="Aujourd'hui")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Permission', models.DateField(default=datetime.date(2020, 6, 6))),
